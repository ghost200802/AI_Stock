...
class HeadShoulderBottomDetector(BasePatternDetector):
    ...
    def _check_window(self, window: list, kline_df) -> "PatternResult | None":
        ...
        expected_dirs = [BiDirection.DOWN, BiDirection.UP, BiDirection.DOWN, BiDirection.UP, BiDirection.DOWN, BiDirection.UP]
        ...
        if b1.end_date != b3.end_date and b1.start_index != b3.start_index:
        ...
        key_points = [
            ...
            KeyPoint(name="breakout", date=b5.end_date, price=last_close, bi_index=5),
        ]
...
def _estimate_days(date1, date2) -> int:
    import pandas as pd
