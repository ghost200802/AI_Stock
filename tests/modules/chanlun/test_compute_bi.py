...
class TestComputeBiEndToEnd:
    ...
    def test_basic_bi_computation(self):
        kline_data = [
            ...
            ("2024-01-03", 11, 15, 10, 14, 100),
            ("2024-01-04", 14, 16, 13, 15, 100),
            ("2024-01-05", 15, 14, 11, 12, 100),
            ("2024-01-06", 12, 13, 10, 11, 100),
            ("2024-01-07", 11, 12, 7, 8, 100),
            ("2024-01-08", 8, 11, 7, 10, 100),
            ("2024-01-09", 10, 13, 9, 12, 100),
            ("2024-01-10", 12, 14, 11, 13, 100),
            ("2024-01-11", 13, 17, 12, 16, 100),
            ("2024-01-12", 16, 18, 15, 17, 100),
            ("2024-01-13", 17, 16, 12, 13, 100),
            ("2024-01-14", 13, 14, 10, 11, 100),
            ("2024-01-15", 11, 12, 6, 7, 100),
        ]
    ...
    def test_returns_expected_columns(self):
        kline_data = [
            ("2024-01-01", 10, 11, 9, 10, 100),
            ("2024-01-02", 10, 15, 9, 14, 100),
            ("2024-01-03", 14, 16, 13, 15, 100),
            ("2024-01-04", 15, 14, 11, 12, 100),
            ("2024-01-05", 12, 13, 10, 11, 100),
            ("2024-01-06", 11, 12, 6, 7, 100),
            ("2024-01-07", 7, 11, 6, 10, 100),
            ("2024-01-08", 10, 13, 9, 12, 100),
            ("2024-01-09", 12, 18, 11, 17, 100),
            ("2024-01-10", 17, 19, 16, 18, 100),
            ("2024-01-11", 18, 17, 13, 14, 100),
            ("2024-01-12", 14, 15, 11, 12, 100),
            ("2024-01-13", 12, 13, 5, 6, 100),
        ]
        df = _make_kline_df(kline_data)
        result = compute_bi(df)
